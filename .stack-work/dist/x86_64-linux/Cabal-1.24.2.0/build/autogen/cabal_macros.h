...
/* package Haskell99ReaderWriterState-0.1.0.0 */
#define VERSION_Haskell99ReaderWriterState "0.1.0.0"
#define MIN_VERSION_Haskell99ReaderWriterState(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Haskell99ReaderWriterState-0.1.0.0-2rzng8ObeTiCXjwW2WVPQJ"

#define CURRENT_PACKAGE_KEY "Haskell99ReaderWriterState-0.1.0.0-2rzng8ObeTiCXjwW2WVPQJ"
